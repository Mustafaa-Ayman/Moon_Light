...
const onFavoriteClick = async () => {
  if (onRequest || !listFavorites) return;  // Add this check for listFavorites
        ...
        <ImageHeader imgPath={tmdbConfigs.backdropPath(media.backdrop_path || 
          ...
          <Box sx={{
            ...
            ...uiConfigs.style.mainContent
                ...
                <Box sx={{
                  ...
                  <Box sx={{
                    ...
                    <Stack spacing={5}>
                      ...
                      >
                        {`${media.title || media.name} ${mediaType === tmdbConfigs.mediaType.movie ? media.release_date.split("-")[0] : 
                      ...
                      <Stack direction="row" spacing={1}>
                        ...
                        <Button
                          ...
                          onClick={()=> videoRif.current.scrollIntoView()}
                        >
                          watch now
              ...
              {/* media vedios */}
              <div ref={videoRif} style={{paddingTop:"2rem"}}>
              ...
              {/* media reviews */}
              <MediaReview reviews={media.reviwes} media={media} mediaType={mediaType}/>
